...
Next.js Pages Router app for aktivitetskrav. Owned by Team eSyfo (`navikt`).

## Source map

`src/pages/` owns routes, `src/components/` UI, `src/data/` data access, `src/env/` environment handling, and `src/schema/` validation.
